class Config {
    ...
    getFontFamily() {
        const fontFamilies = {
            monospace:
                'JetBrains Mono, Fira Code Retina, Hack, Ubuntu Mono, Monaco, Lucida Console, monospace',
            'sans-serif':
                'Cantarell, Inter, SF Pro Text, Roboto, Open Sans, sans-serif',
            serif: 'serif',
        };
    ...
    getWebSites() {
        ...
        const webSites = [
            ...
            },
            {
                site: 'YouTube Studio',
                icon: 'youtube-studio',
                url: 'https://studio.youtube.com/channel/UCCWBy4zBz2_7wwgl9zp7Kow',
                category: 'media',
            },
            {
                site: 'VidIQ',
                icon: 'vidiq',
                url: 'https://app.vidiq.com/channels/42e48bd6-2937-4eb0-8d46-8fe490299863/dashboard',
                category: 'media',
            },
            {
                site: 'Canva',
